...
-----------------------------------------------------------------
                        notes
-----------------------------------------------------------------
- continue with the goomba stuff, see the spawn enemy methods, you shall 
  go forward from there (the collision is handled setting the goomba as a Tile instead of dynamic)
- take a relook at the replay lecture and perhaps implement some
- build a system for reading the map from the file relesed by Tiled (software)
  perhaps you could organize the file like a matrix so that you can have the x,y coordinates
-----------------------------------------------------------------
                   debugging notes 
-----------------------------------------------------------------
